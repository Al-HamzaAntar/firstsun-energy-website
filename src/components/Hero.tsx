      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button size="lg" className="bg-orange-500 hover:bg-orange-600 text-white font-semibold px-8 py-4 text-lg transition-all duration-300 transform hover:scale-105" onClick={() => scrollToSection('services')}>
              استكشف خدماتنا
            </Button>
            <Button variant="outline" size="lg" onClick={() => scrollToSection('contact')} className="border-white hover:bg-white font-semibold px-8 py-4 text-lg transition-all duration-300 transform hover:scale-105 text-zinc-800">
              تواصل معنا
            </Button>
          </div>
        </div>
