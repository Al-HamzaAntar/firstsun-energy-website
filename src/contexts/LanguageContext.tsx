...
const translations: Translations = {
  ...
  'contact.street': { ar: ' الجمهوريةاليمنية - صنعاء - شارع الأربعين - جولة الثقافة - مقابل مفروشات المدينة التركية', en: 'Republic of Yemen - Sana\'a - Al-Arbaeen Street - Culture Roundabout - opposite Turkish City Furniture' },
