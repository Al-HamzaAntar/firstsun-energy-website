...
const translations: Translations = {
  ...
  'products.panels.badge': { ar: 'شعبية من الدرجة الأولى', en: 'Top-Tier Popularity' },
  'products.panels.title': { ar: 'TW SOLAR', en: 'TW SOLAR' },
  'products.panels.description': { ar: 'يتم تسليط الضوء عليها كواحدة من العلامات التجارية "الأكثر شيوعًا"، مع التركيز على تقديم أحدث التقنيات في الألواح الشمسية.', en: 'Highlighted as one of the "Most Popular" brands, focusing on delivering the latest technology in solar panels.' },
  
  'products.inverters.badge': { ar: 'إمكانية التحكم عن بعد', en: 'Remote Control Capability' },
  'products.inverters.title': { ar: 'Hexcell', en: 'Hexcell' },
  'products.inverters.description': { ar: 'توفر مقاييس "ذكية" بتركيز فريد على الدقة العالية وقدرات التحكم عن بعد المتكاملة.', en: 'Offers "Smart" meters with a unique focus on high accuracy and integrated remote control capabilities.' },
  
  'products.batteries.badge': { ar: 'حلول طويلة الأمد', en: 'Long-Lasting Solutions' },
  'products.batteries.title': { ar: 'FNIRSI', en: 'FNIRSI' },
  'products.batteries.description': { ar: 'تتميز بتقديم حلول طاقة "طويلة الأمد" مدعومة بمعدات عالية الجودة ومواصفات متقدمة.', en: 'Distinguished by offering "Long-lasting" energy solutions backed by high-quality equipment and advanced specifications.' },
  
  'products.systems.badge': { ar: 'توليد الطاقة القصوى', en: 'Power Generation Maximized' },
  'products.systems.title': { ar: 'KUKA CABLE', en: 'KUKA CABLE' },
  'products.systems.description': { ar: 'تتموضع كشركة رائدة "الأكثر شيوعًا" في تكنولوجيا الطاقة الشمسية المخصصة لتحقيق أقصى قدر من توليد الطاقة.', en: 'Positioned as a "Most Popular" leader in solar technology dedicated to achieving maximum power generation.' },
  
  'products.meters.badge': { ar: 'المراقبة الذكية', en: 'Intelligent Monitoring' },
  'products.meters.title': { ar: 'SINENG', en: 'SINENG' },
  'products.meters.description': { ar: 'تركز على "التكنولوجيا المتقدمة" في العاكسات الذكية، وتؤكد على المراقبة الذكية إلى جانب الكفاءة العالية.', en: 'Focuses on "Advanced Technology" in smart inverters, emphasizing intelligent monitoring alongside high efficiency.' },
  
  'products.accessories.badge': { ar: 'متانة استثنائية', en: 'Exceptional Durability' },
  'products.accessories.title': { ar: 'MIBET ENERGY', en: 'MIBET ENERGY' },
  'products.accessories.description': { ar: 'تُعرف بكونها الخيار "الأكثر شيوعًا" بفضل مزيج من الكفاءة العالية والمتانة الاستثنائية.', en: 'Known for being the "Most Popular" choice due to a combination of high efficiency and exceptional durability.' },
